# Generated by Django 4.0.3 on 2022-03-11 21:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('backpic_url', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='pfpback', to='database.file')),
                ('pic_url', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='pfp', to='database.file')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('stopped_date', models.DateTimeField(null=True)),
