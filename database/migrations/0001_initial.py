# Generated by Django 4.0.3 on 2022-03-19 17:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('interaction_counter', models.CharField(max_length=50)),
                ('post_location', models.CharField(max_length=7)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Lt_t_un_changed', models.DateTimeField(blank=True, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='user_settings',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('user_state', models.CharField(max_length=12)),
                ('state', models.CharField(max_length=12)),
                ('create_date', models.DateTimeField()),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='database.post')),
            ],
        ),
        migrations.CreateModel(
            name='post_page',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sender', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='database.particpant')),
                ('thread', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='database.thread')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file_extension', models.CharField(blank=True, max_length=6, null=True)),
                ('file_type', models.CharField(blank=True, max_length=6, null=True)),
                ('comment', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='database.comment')),
            ],
        ),
        migrations.AddField(
            model_name='comment',
